...
public class JdbcPractice {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String sql12= "select avg(salary) as avg from developers group by prog_lang order by avg asc";
        ResultSet rs12 = st.executeQuery(sql12);
        while(rs12.next()){
            System.out.println("Programlama Dili : " + rs12.getString(1) +
                    " --- Ortalama Maaş : " + rs12.getDouble("avg"));
        }
        ...
        String sql13= "SELECT prog_lang, COUNT(*) as developer_sayisi, SUM(salary) as toplam_maas FROM developers GROUP BY prog_lang ORDER BY developer_sayisi DESC";
        ResultSet rs13 = st.executeQuery(sql13);
        while(rs13.next()){
            System.out.println("Programlama Dili : " + rs13.getString(1) +
                    " --- Geliştirici Sayısı : " + rs13.getInt("developer_sayisi") +
                    " --- Toplam Maaş : " + rs13.getDouble("toplam_maas"));
        }
